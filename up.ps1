...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.fptapp.localhost/ --auth https://id.fptapp.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.fptapp.localhost/ --auth https://id.fptapp.localhost/ --allow-write true
}
...
Start-Process https://cm.fptapp.localhost/sitecore/
Start-Process https://www.fptapp.localhost/
