            ...
            services.AddSitecoreRenderingEngine(options =>
                {
                    options
                        ...
                        .AddModelBoundView<PromoComponentModel>("PromoComponent")
                        .AddModelBoundView<DownloadSection>("DownloadSection")
                        .AddModelBoundView<FeatureSectionModel>("FeatureSection")
